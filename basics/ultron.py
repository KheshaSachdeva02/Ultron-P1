...
def taskExecution():
    ...
    def startapp():
        ...
        app = takecommand()
        speak("Okay Mam... Opening the application")
        if 'code' in app:
            os.startfile(
                "E:\\Microsoft VS Code\\Code.exe")
        elif 'WhatsApp' in app:
            os.startfile(
                "C:\\Users\\laptopexpert\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
    ...
    def WhatsApp():
        ...
        if 'mum' in person:
            ...
            speak("Minute?")
            min = int(takecommand())
            pywhatkit.sendwhatmsg("+91 9217866789", mess, hr, min, 20)
    ...
    def SetAlarm():
        ...
        while True:
            ...
            if noww == time:
                ...
                playsound(
                    'E:\\SEM6-SM\\Minor Project\\Project\\ULTRON\\basics\\play.mp3')
    ...
    while True:
        ...
        if 'hello' in query:
            speak('Hello Mam! Ultron is in your service now! What can I do for You?')

        elif 'how are you' in query:
            speak("I'm good and ready to serve you")

        elif 'bye bye' in query:
            speak("Ok Mam! Bye Bye.. You can call me anytime!")
            break
            ...
            loc = location+'.png'
            path = "E:\\SEM6-SM\\Minor Project\\Project\\Screenshots\\"+loc
            ...
            if 'yes' in opinion:
                os.startfile(
                    f"E:\\SEM6-SM\\Minor Project\\Project\\Screenshots\\{loc}")
            else:
                speak("Okayy!!")
